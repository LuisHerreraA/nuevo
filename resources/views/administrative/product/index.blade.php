      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="/administrative/product">PRODUCTO</a></li>
...
@section('cuerpo')
  <div class="administrativeWindow" style="visibility: hidden">
    ...
    <button class='btn btn-warning btn-sm' id='pdfProduct'>PDF</button>
    <br><br>
    <table class="table" id="tableProductAdmi">
      <thead>
        <th>ID</th>
        <th>PRODUCTO</th>
        <th>DESCRIPCION</th>
